	...
	<div class="main-area center-text" style="background-image:url(/img/background.jpg);">
		...
		<div class="display-table">
			<div class="display-table-cell">
                ...
                <h1 class="title font-white"><b>Gleich wieder da...</b></h1>
                <a class="notify-btn" href=""><b> ( <span id="count">15s</span> ) Seite neu laden</b></a>
				<p class="desc font-white">Eine Wartung läuft gerade im Hintergrund. Sollte diese Nachricht länger als 15 Minuten erscheinen: </p>
				
				<a class="notify-btn" href="mailto:j.schneider@gemuesering.de"><b>E-Mail</b></a>
