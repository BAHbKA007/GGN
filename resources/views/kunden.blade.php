                ...
                <div class="card" style="margin-bottom:20px">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                            ...
                            <div class="form-row">
                                <div class="col-md-10">
                                    <input id="focus" @if (isset($var['kunden_edit'])) value="{{$var['kunden_edit']->name}}" @endif type="text" class="form-control form-control-sm" name="name" placeholder="Kunde" required autocomplete="off">
                                </div>
